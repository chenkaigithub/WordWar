...
-(CCAnimation*)loadPlistForAnimationWithName:(NSString*)animationName andClassName:(NSString*)className withPrefix:(NSString*)prefix{
    ...
    NSString *animationFramePrefix = [animationSettings objectForKey:@"framePrefix"];
    ...
    for (NSString *frameNumber in animationFrameNumbers) {
        NSString *frameName = [NSString stringWithFormat:@"%@%@%@.png",prefix, animationFramePrefix,frameNumber];
